...
function Spooky(options, customOptions, callback) {
    ...
    // extend child with custom data, this will be available via (this.cli.options)
    _.extend(options.child, customOptions);
